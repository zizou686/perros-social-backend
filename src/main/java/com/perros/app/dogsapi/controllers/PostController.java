...
public class PostController {
    ...
    // Inyectamos el template para enviar mensajes WebSocket
    @Autowired
    ...
    public PostDTO createPost(@Valid @RequestBody Post postRequest) {
        ...
        PostDTO dto = convertToDTO(savedPost);
 
        // 🔔 Notificar a todos los clientes conectados que hay una nueva publicación
    ...
    public ResponseEntity<?> deletePost(@PathVariable Long id) {
        ...
        try {
            // Dejar que el cascade de JPA elimine comentarios y likes automáticamente
